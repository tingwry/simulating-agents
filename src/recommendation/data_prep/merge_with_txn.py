...
train_with_lifestyle_pred_T1 = pd.read_csv('src/recommendation/data/T1_predicted/train_with_lifestyle_single.csv')
...
merged_data.to_csv('src/recommendation/data/T1_predicted/demog_ranking_grouped_catbased_no_norm_single.csv', index=False)