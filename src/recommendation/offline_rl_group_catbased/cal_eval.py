...
# Load your data
# binary_predictions = pd.read_csv('src/recommendation/offline_rl_group_catbased/predictions/transaction_predictions.csv')
# probability_predictions = pd.read_csv('src/recommendation/offline_rl_group_catbased/predictions/transaction_scores.csv')
binary_predictions = pd.read_csv('src/recommendation/offline_rl_group_catbased/predictions/transaction_predictions_percentile_75.csv')
probability_predictions = pd.read_csv('src/recommendation/offline_rl_group_catbased/predictions/transaction_scores_percentile_75.csv')
...
detailed_results, metrics = evaluate_transaction_predictions(
    ...
    output_folder="src/recommendation/offline_rl_group_catbased/eval_results_percentile_75"
)
