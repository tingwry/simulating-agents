...
binary_predictions = pd.read_csv('src/recommendation/multioutputclassifier/T0/predictions/transaction_predictions_grouped_catbased.csv')
probability_predictions = pd.read_csv('src/recommendation/multioutputclassifier/T0/predictions/transaction_predictions_grouped_catbased_scores.csv')
...
detailed_results, metrics = evaluate_transaction_predictions(
    ...
    output_folder="src/recommendation/multioutputclassifier/T0/eval_results_grouped_catbased"
)
