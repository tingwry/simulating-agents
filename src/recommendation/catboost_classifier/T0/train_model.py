...
from sklearn.metrics import f1_score, mean_squared_error, mean_absolute_error, precision_recall_curve, precision_score, r2_score, recall_score, roc_auc_score, accuracy_score
...
MODEL_DIR = 'src/recommendation/catboost_classifier/T0/models_grouped_catbased'
METRICS_DIR = 'src/recommendation/catboost_classifier/T0/metrics_grouped_catbased'
...
def train_and_evaluate_models():
    ...
    results = {}
    optimal_thresholds = {}  # Store optimal thresholds for each category
    ...
    for category in categories:
        ...
        # Convert to binary classification problem (1 if transaction count > 0)
        ...
        optimal_threshold = find_optimal_threshold(y_test, y_val_proba)
