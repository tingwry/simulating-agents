...
binary_predictions = pd.read_csv('src/recommendation/evaluation/baseline/data/all_1_grouped_catbased.csv')
...
detailed_results, metrics = evaluate_transaction_predictions(
    ...
    output_folder="src/recommendation/evaluation/baseline/eval_results_grouped_catbased"
)
