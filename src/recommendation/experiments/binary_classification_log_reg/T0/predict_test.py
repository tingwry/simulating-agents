...
PREDICTION_OUTPUT = 'src/recommendation/binary_classification_log_reg/T0/predictions/transaction_predictions.csv'
...
def run_predictions():
    ...
    # Initialize all category columns with zeros first
    ...
    missing_categories = set(categories) - set(predictions_df.columns)
    for cat in missing_categories:
        predictions_df[cat] = 0
