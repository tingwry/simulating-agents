...
from sklearn.metrics import mean_squared_error, mean_absolute_error, precision_score, r2_score, recall_score, accuracy_score
...
def train_and_evaluate_models():
    ...
    for category in categories:
        ...
        optimal_threshold = find_optimal_regression_threshold(y_test, y_val_pred)
        optimal_thresholds[category] = optimal_threshold
        
        # Evaluate with optimal threshold
        y_pred_binary = (y_val_pred >= optimal_threshold).astype(int)
