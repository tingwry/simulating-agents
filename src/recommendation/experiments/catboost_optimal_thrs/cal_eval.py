...
binary_predictions = pd.read_csv('src/recommendation/catboost/predictions/transaction_predictions_grouped_catbased.csv')
probability_predictions = pd.read_csv('src/recommendation/catboost/predictions/transaction_predictions_grouped_catbased_scores.csv')

binary_predictions_T1 = pd.read_csv('src/recommendation/catboost/T1/predictions/transaction_predictions_grouped_catbased.csv')
probability_predictions_T1 = pd.read_csv('src/recommendation/catboost/T1/predictions/transaction_predictions_grouped_catbased_scores.csv')
...
detailed_results, metrics = evaluate_transaction_predictions(
    ...
    output_folder="src/recommendation/catboost/eval_results_grouped_catbased"
    # output_folder="src/recommendation/catboost/T1/eval_results_grouped_catbased"
)
