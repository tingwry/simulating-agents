...
MODEL_DIR = 'src/recommendation/multioutputclassifier/T0/models_grouped_catbased'
METRICS_DIR = 'src/recommendation/multioutputclassifier/T0/metrics_grouped_catbased'
