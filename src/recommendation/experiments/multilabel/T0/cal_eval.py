...
binary_predictions = pd.read_csv('src/recommendation/multilabel/T0/predictions/transaction_predictions_grouped_catbased.csv')
probability_predictions = pd.read_csv('src/recommendation/multilabel/T0/predictions/transaction_predictions_grouped_catbased_scores.csv')
...
detailed_results, metrics = evaluate_transaction_predictions(
    ...
    output_folder="src/recommendation/multilabel/T0/eval_results_grouped_catbased"
)
