...
# Load your data
binary_predictions = pd.read_csv('src/recommendation/binary_classification/T0/predictions/transaction_predictions.csv')
probability_predictions = pd.read_csv('src/recommendation/binary_classification/T0/predictions/transaction_predictions_probabilities.csv')
...
detailed_results, metrics = evaluate_transaction_predictions(
    ...
    output_folder="src/recommendation/binary_classification/T0/eval_results"
)
