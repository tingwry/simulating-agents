...
# Load your data
transaction_predictions = pd.read_csv('src/recommendation/cluster_based/T0/predictions/transaction_predictions.csv')
...
detailed_results, metrics = evaluate_transaction_predictions(
    ...
    ans_key, 
    output_folder="src/recommendation/cluster_based/eval/eval_results"
)
