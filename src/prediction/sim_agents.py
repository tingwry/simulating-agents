...
if __name__ == "__main__":
    ...
    # testtest = test_summ[test_summ['CUST_ID'].isin([1214])]
    ...
    similar_output_file = "src/prediction/similar_cust_results/v1/sim_cust_results.json"
    
    # Process customers and save results
    results_df = process_customers(testtest, method="cluster", stage="multi", change_analysis=True, batch_size=None)
    save_final_results(results_df, output_dir, 'predictions_cluster_multi_ca_const')