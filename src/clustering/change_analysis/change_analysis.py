...
full_data_with_cluster = pd.read_csv('src/clustering/approach_2/result/full_data_with_cluster/full_data_with_cluster_v4.csv')
train_T0_df_group = pd.read_csv('src/clustering/approach_2/result/clus_explain/clus_explain_v4.csv')
