...
# preprocess(filtered_mock, col_selected_T1, col_map_T1, "test_T1_actual.csv", ACTUAL_DIR)

# train T1
filtered_mock = mock_cust_df[mock_cust_df['cust_id'].isin(train_df['CUST_ID'])]
preprocess(filtered_mock, col_selected_T1, col_map_T1, "train_T1.csv", TRAIN_T1_DIR)