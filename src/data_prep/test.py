...
# test_t1_actual = pd.read_csv('src/test_T1_actual/test_T1_actual_v3.csv')
...
# test_t1_actual.to_csv('src/test_T1_actual/test_T1_actual_v3.csv', index=False)
...
# train_T1.to_csv('src/train_T1/train_T1_v3.csv', index=False)
